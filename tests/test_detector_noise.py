...
def test_shot_noise_generation(default_detector_shot_noise, default_digitizer):
    ...
    dataframe = detector.get_initialized_signal(run_time=100 * units.microsecond, signal_digitizer=default_digitizer)
...
def test_thermal_noise_generation(default_detector_thermal_noise, default_digitizer):
...
def test_dark_current_noise_generation(default_detector_dark_current, default_digitizer):
...
def test_combined_noise_generation(default_detector_shot_noise, default_digitizer):
