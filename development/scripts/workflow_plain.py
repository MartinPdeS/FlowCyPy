...
#     name="Pop 1",
#     particle_count=5e9 * ureg.particle / ureg.milliliter,
#     core_diameter=distribution.RosinRammler(200 * ureg.nanometer, spread=30),
#     core_refractive_index=distribution.Normal(1.44 * ureg.RIU, standard_deviation=0.002 * ureg.RIU),
#     shell_thickness=distribution.RosinRammler(200 * ureg.nanometer, spread=30),
#     shell_refractive_index=distribution.Normal(1.64 * ureg.RIU, standard_deviation=0.002 * ureg.RIU),
# )
