...
from FlowCyPy.population import HDL, Exosome, get_microbeads
...
scatterer.add_population(
    get_microbeads(name="pop_0", size=50 * nanometer, refractive_index=1.4 * RIU),
    particle_count=5 * particle,
)

scatterer.add_population(
    get_microbeads(name="pop_1", size=80 * nanometer, refractive_index=1.4 * RIU),
    particle_count=5 * particle,
)

scatterer.add_population(
    get_microbeads(name="pop_2", size=100 * nanometer, refractive_index=1.4 * RIU),
    particle_count=5 * particle,
)

scatterer.add_population(
    get_microbeads(name="pop_3", size=200 * nanometer, refractive_index=1.4 * RIU),
    particle_count=5 * particle,
)
...
analyzer.get_coincidence(
    margin=0.1 * microsecond
)  # Coincidence data with 0.1 µs margin
