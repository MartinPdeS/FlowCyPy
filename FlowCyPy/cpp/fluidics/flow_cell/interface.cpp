...
PYBIND11_MODULE(flow_cell, module) {
    ...
    py::class_<FlowCell, std::shared_ptr<FlowCell>>(module, "FlowCell")
        .def(
            py::init(
            ...
            R"pbdoc(
                ...
                - the summation is over odd integers.
                ...
                **References**
                ...
                dpdx : float
                    Computed pressure gradient driving the flow.
                u_center : float
                    Centerline velocity, i.e. u(0,0).
                sample : FluidRegion
                    Focused sample region.
                sheath : FluidRegion
                    Remaining sheath region.
                event_scheme : str
                    Default event sampling scheme used by ``sample_arrival_times``.
            )pbdoc"
        )
        .def_property_readonly(
            "width",
