...
class Base:
    ...
    def plot(self, axes: plt.Axes, n_samples: int = 4000, bins: int = 50) -> None:
        """
        ...
        # Plotting the PDF
        axes.hist(samples, bins=bins, color="blue", edgecolor="black", alpha=0.7)
    ...
    def pre_generate(function: Callable) -> Callable:
        def wrapper(self, n_samples: AnyUnit):
