...
from ._peak_locator import BasePeakLocator
from ._peak_locator import SlidingWindowPeakLocator
from ._peak_locator import GlobalPeakLocator
...
class GlobalPeakLocator(GlobalPeakLocator, _Base):
    pass
