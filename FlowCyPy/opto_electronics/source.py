...
class AstigmaticGaussianBeam(BaseBeam, StrictDataclassMixing):
    ...
    numerical_aperture_y : Optional[float]
    ...
    numerical_aperture_z : Optional[float]
    ...
    optical_power: Power
    wavelength: Length
    numerical_aperture_y: Optional[float] = None
    numerical_aperture_z: Optional[float] = None
