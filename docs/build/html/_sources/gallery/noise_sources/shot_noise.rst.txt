...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    /Users/m.poinsinetdesivry-houle/Desktop/GitRepositories/FlowCyPy/docs/examples/noise_sources/shot_noise.py:71: UserWarning: No artists with labels found to put in legend.  Note that artists whose label start with an underscore are ignored when legend() is called with no argument.
      ax_signal.legend()
