...
.. GENERATED FROM PYTHON SOURCE LINES 50-120
...
.. code-block:: pytb
    ...
    Traceback (most recent call last):
      File "/Users/m.poinsinetdesivry-houle/Desktop/GitRepositories/FlowCyPy/docs/examples/extras/continuous_acquisition.py", line 110, in <module>
        acquisition.signal.plot()
        ^^^^^^^^^^^^^^^^^^
    AttributeError: 'Acquisition' object has no attribute 'signal'
