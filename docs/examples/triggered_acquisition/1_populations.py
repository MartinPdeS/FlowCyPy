...
from FlowCyPy.units import particle, milliliter, nanometer, RIU, AU, milliwatt, millivolt
...
experiment = cytometer.get_triggered_acquisition(
    run_time=0.2 * millisecond,
    threshold=3 * millivolt,
...
experiment.detect_peaks(multi_peak_strategy='max')
