...
population_0 = Population(
    name='Pop 0',
    particle_count=600 * particle,
    size=distribution.Normal(mean=150 * nanometer, std_dev=1 * nanometer),
    refractive_index=distribution.Normal(mean=1.42 * RIU, std_dev=0.08 * RIU)
)

population_1 = Population(
    name='Pop 1',
    particle_count=600 * particle,
    size=distribution.Normal(mean=100 * nanometer, std_dev=1 * nanometer),
    refractive_index=distribution.Normal(mean=1.42 * RIU, std_dev=0.08 * RIU)
)
...
# population_1 = Population(
#     name='Pop 1',
#     particle_count=300 * particle,
#     size=distribution.Normal(mean=150 * nanometer, std_dev=10 * nanometer),
#     refractive_index=distribution.Normal(mean=1.42 * RIU, std_dev=0.002 * RIU)
# )
