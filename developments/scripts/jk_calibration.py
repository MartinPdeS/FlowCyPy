...
calibration  = Calibration(
    ...
    illumination_powers=[60, 80, 100, 120, 160, 200, 400] * units.milliwatt,  # Illumination powers in milliwatts,
    ...
    number_of_background_events=10_000 * units.event,                         # Number of background events to simulate
